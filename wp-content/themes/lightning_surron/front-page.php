...
<body class="min-h-screen bg-zinc-950 text-white font-sans selection:bg-yellow-500 selection:text-black">
    ...
    <header class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0" id="hero-slideshow">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hero-1.jpg" alt="Hero Background 1"
                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-100" />
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hero-2.jpg" alt="Hero Background 2"
                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-0" />
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hero-3.jpg" alt="Hero Background 3"
                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-0" />
        </div>
        ...
        <div class="relative z-20 container mx-auto px-6 text-center md:text-left">
            ...
            <h1 class="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-6 leading-tight">
                サーロン <br />
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-500">正規ディーラー</span>
            </h1>
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="bg-zinc-900 p-6 border-l-4 border-blue-500">
                            ...
                            <h4 class="font-bold text-lg mb-2">SUR-RON正規店</h4>
                            <p class="text-sm text-zinc-500">販売からメンテナンス、カスタムまでトータルサポート。</p>
                        </div>
                    </div>
                </div>
                <div class="relative flex items-center justify-center p-8">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/about-logo.png"
                        alt="SUR-RON Logo"
    ...
    <section id="services" class="py-24 bg-zinc-900">
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <!-- Woods Motorland -->
                <a href="https://hirata-auto.com/woods/" target="_blank" class="group relative overflow-hidden h-80 cursor-pointer block">
            ...
            <div class="grid lg:grid-cols-5 gap-12">
                <div class="lg:col-span-2 space-y-8">
                    <div id="access">
                        ...
                        <h2 class="text-4xl font-bold mb-2">サーロンショップ<br />ヒラタ自動車</h2>
    ...
    <section id="contact" class="py-24 bg-zinc-900">
        <div class="container mx-auto px-6 max-w-4xl max-w-4xl mx-auto">
            ...
            <div class="mt-8">
                <?php echo do_shortcode('[contact-form-7 id="f441385" title="サーロン問い合わせ"]'); ?>
            </div>
